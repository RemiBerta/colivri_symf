 ...
 */
final class Version20250821133414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, listing_id INT NOT NULL, url VARCHAR(600) NOT NULL, description VARCHAR(255) NOT NULL, sort_order INT DEFAULT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_16DB4F89A76ED395 (user_id), INDEX IDX_16DB4F89D4619D1A (listing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
